            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="relative h-64 md:h-full overflow-hidden">
                <img
                  ...
                  loading="eager"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#030a16]/80 hidden md:block" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#030a16]/80 to-transparent md:hidden" />
