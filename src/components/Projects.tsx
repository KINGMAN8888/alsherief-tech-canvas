      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-8">
        ...
        >
          {projects.map((p, i) => {
            ...
            const description = t(`projects.items.${p.slug}.description`);
            return (
              <motion.div
                key={p.slug}
                variants={itemVariants}
                className="group relative flex flex-col rounded-2xl border border-slate-800/60 bg-slate-900/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-slate-700/80 hover:bg-slate-800/20 cursor-pointer"
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  {p.github && (
                    <a
                      ...
                      className="relative z-10 absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full bg-slate-900/70 backdrop-blur-sm border border-slate-700/50 text-slate-400 transition-all duration-300 hover:text-white hover:border-cyan-500/50 hover:bg-slate-800/80"
                    >
