        ...
        >
          {services.map((s, idx) => (
            <motion.div
              ...
              className={`svc-card svc-theme-${idx} group relative flex flex-col rounded-2xl border border-slate-800/60 bg-slate-900/50 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:-translate-y-1`}
            >
              {/* Gradient top bar */}
