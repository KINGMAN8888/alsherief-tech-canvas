...
/* ─── stat defs (label comes from i18n) ─── */
const statDefs = [
  { labelKey: "hero.stats.yearsExp", value: 5, suffix: "+", icon: Terminal },
  { labelKey: "hero.stats.projects", value: 30, suffix: "+", icon: Layers },
  { labelKey: "hero.stats.technologies", value: 20, suffix: "+", icon: Cpu },
  { labelKey: "hero.stats.countries", value: 3, suffix: "", icon: Globe },
];
...
const socialLinks = [
  {
    icon: Linkedin,
    label: "LinkedIn",
    href: "https://linkedin.com/in/youssefalsherief",
    hoverColor: "#3b82f6",
  ...
  },
  {
    icon: Facebook,
    label: "Facebook",
    href: "https://facebook.com/kingsmanjou",
    hoverColor: "#60a5fa",
  ...
  },
  {
    icon: Instagram,
    label: "Instagram",
    href: "https://instagram.com/kingman_jou",
    hoverColor: "#f472b6",
...
const Hero = () => {
  ...
  return (
    <section className="hero-root relative flex min-h-screen items-center justify-center overflow-hidden bg-[#020617]">
