          ...
          <div className="hidden items-center gap-1 lg:flex">
            {navLinks.map((l) => (
              <a
                key={l.href}
                href={getHref(l.href)}
                className={`relative px-3 py-1.5 font-rajdhani text-sm font-semibold tracking-wide transition-colors duration-200 rounded-lg ${
                  isActive(l.href)
                    ? "text-cyan-400"
                  ...
                  >
                    {langs.map((lang) => (
                      <button
                        ...
                        className={`w-full flex items-center gap-2.5 px-3 py-2.5 font-rajdhani text-sm font-semibold transition-colors duration-150 ${
                          locale === lang.code
                ...
                <div className="space-y-1">
                  {navLinks.map((l, i) => (
                    <motion.a
                      ...
                      className={`flex items-center justify-between rounded-xl px-4 py-3 font-rajdhani text-base font-semibold tracking-wide transition-all duration-200 ${
                        isActive(l.href)
                    ...
                    >
                      ...
                      <ChevronRight
                        className={`h-4 w-4 transition-colors ${
                          isActive(l.href) ? "text-cyan-400" : "text-slate-600"
                        }`}
                      />
                    </motion.a>
                  ))}
                  ...
                  <div className="flex gap-2 px-2">
                    {langs.map((lang) => (
                      <button
                        key={lang.code}
                        onClick={() => switchLocale(lang.code)}
                        className={`flex-1 flex items-center justify-center gap-1.5 rounded-lg border py-2 font-rajdhani text-xs font-bold transition-all duration-150 ${
                          locale === lang.code
