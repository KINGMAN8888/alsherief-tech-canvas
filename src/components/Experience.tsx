  ...
  return (
    <section id="experience" className="relative py-28 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, rgba(6,182,212,0.06) 1px, transparent 1px), linear-gradient(225deg, rgba(139,92,246,0.04) 1px, transparent 1px)",
              ...
              <motion.div
                ...
                className={`relative mb-12 md:w-1/2 ${isRTL
                  ? isLeft
                    ...
                    : "pr-14 md:pr-0 md:mr-auto md:pr-14"
                  : isLeft
                    ...
                    : "pl-14 md:pl-0 md:ml-auto md:pl-14"
                  }`}
              >
                {/* Timeline node */}
                <div
