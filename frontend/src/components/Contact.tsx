...
/* ─── social definitions — key maps to profile.social ─── */
const socials = [
  {
    icon: Linkedin,
    label: "LinkedIn",
    key: "linkedin",
    fallback: "https://www.linkedin.com/in/youssefalsherief",
  ...
  },
  {
    ...
    label: "Facebook",
    key: "facebook",
    fallback: "https://www.facebook.com/kingsmanjou",
  ...
  },
  {
    ...
    label: "Instagram",
    key: "instagram",
    fallback: "https://www.instagram.com/kingman_jou",
...
const Contact = () => {
  ...
  const profileSocial = profile?.social as Record<string, string> | undefined;

  const contactInfo = [
    {
      icon: Mail,
      label: t("contact.emailLabel"),
      value: profile?.email || "yousefmahmoudsaber@gmail.com",
    ...
    },
    {
      ...
      value: profile?.phone || "+20 109 758 5951",
    ...
    },
    {
      ...
      value: profile?.location || t("contact.location"),
      href: undefined,
      color: "from-violet-500 to-purple-500",
    },
  ];

  // Dynamic social mapping from profile data
  const activeSocials = socials.map(s => ({
    ...s,
    href: profileSocial?.[s.key] || s.fallback,
  })).filter(s => s.href);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Try EmailJS but don't fail if it's not configured
